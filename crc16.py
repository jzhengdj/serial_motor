# -*- coding: utf-8 -*-
"""
Created on Mon Aug 27 17:20:53 2018

@author: http://cms.digi.com/resources/documentation/digidocs/90001537/references/r_python_crc16_modbus.htm?tocpath=Rockwell%20Allen-Bradley%7C_____2
"""
...
def cmp_result(correctCrc, crc):
    if crc != correctCrc:
        print ("BAD - ERROR - FAILED!")
        print ("expect:0x%x but saw 0x%x" % (correctCrc,crc))
    else:
        print ("Ok")
def test_function(st, correctCrc):
    print("testing Modbus messages with crc16.py")
    print("testing string:", st)
    crc = calcString(st, INITIAL_MODBUS)
    cmp_result(correctCrc, crc)
