...
TOLERANCE = 0.08  # Define a tolerance for considering the target reached
STABILITY_CHECKS = 6  # Number of consecutive checks to confirm the target is reached
CHECK_INTERVAL = 0.2  # Interval between stability checks in seconds
